...
public class AllPokemons {
    ...
    private final List<WildPokemons> wildPokemons = List.of(
            new WildPokemons("Rattata", "Normal", 10, 40),
            new WildPokemons("Meowth", "Normal", 10, 40),
            new WildPokemons("Bidoof", "Normal", 10, 40),
            new WildPokemons("Sentret", "Normal", 10, 40),
            new WildPokemons("Zigzagoon", "Normal", 10, 40),
            new WildPokemons("Vulpix", "Fire", 10, 40),
            new WildPokemons("Growlithe", "Fire", 10, 40),
            new WildPokemons("Ponyta", "Fire", 10, 40),
            new WildPokemons("Litwick", "Fire", 10, 40),
            new WildPokemons("Fennekin", "Fire", 10, 40),
            new WildPokemons("Magikarp", "Water", 10, 40),
            new WildPokemons("Poliwag", "Water", 10, 40),
            new WildPokemons("Wooper", "Water", 10, 40),
